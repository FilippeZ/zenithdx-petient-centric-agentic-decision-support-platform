...
const STEPS = [
  {
    ...
    subtitle: "Step 1",
    description:
      "Upload your chest X-ray to start the diagnostic process. Our AI performs automatic lung segmentation and multilabel classification, delivering fast, clear results with total transparency.",
    tags: ["S²A-UNet Segmentation", "ResNet-50 Classification", "Fast & Secure"],
    image: xrayImage,
  ...
  },
  {
    ...
    subtitle: "Step 2",
    description:
      "Describe how you are feeling in simple terms. The AI matches your symptoms with medical guidelines to provide clear, personalized explanations.",
    tags: ["Clinical RAG", "Medical Literature Search", "Plain Language"],
    image: howusepatient,
  ...
  },
  {
    ...
    subtitle: "Step 3",
    description:
      "Including your Patient ID allows the system to cross-reference your past medical history, giving your attending clinician a comprehensive longitudinal health picture.",
    tags: ["Longitudinal History", "Patient Record Integration", "Secure Privacy"],
    image: patientid,
    imageAlt: "Patient ID",
  },
];
    ...
    <div style={{ background: "#f8fafc", minHeight: "100vh", color: "#0f172a", fontFamily: "'Inter', sans-serif" }}>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "3rem 1.5rem 6rem" }}>
        ...
        >
          ...
          >
            How ZenithDx Works for Patients
          </motion.h1>
          ...
          >
            Three simple steps to submit your scan, describe symptoms, and receive plain-language diagnostic reports approved by certified medical professionals.
          </motion.p>
        </motion.div>
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <motion.img
                  ...
                  style={{ maxHeight: 240, width: "auto", objectFit: "contain", borderRadius: 16 }}
                />
              </div>
            </motion.div>
          ))}
